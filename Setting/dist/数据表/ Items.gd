...
10014:{ "id":10014,  "name":'卡巴拉之术',  "desc":'神秘的古代魔法。',  "cost":[21, 16],  "bonus":[29, 9],  "img":'Ares.jpg', },
...
10019:{ "id":10019,  "name":'暗物质星系',  "desc":'神秘莫测的星系。',  "cost":[19, 24],  "bonus":[64, 13],  "img":'Holy.png', },
10020:{ "id":10020,  "name":'平行宇宙',  "desc":'在天国阶梯背后，神秘星系背后，隐藏着另一个宇宙。',  "cost":[54, 27],  "bonus":[51, 14],  "img":'Holy.png', },
